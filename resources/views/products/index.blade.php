...
@section('content')
    ...
    <div class="w-full flex flex-col">
        <div class="flex flex-row font-bold text-xl p-3 text-teal-500">
            ...
            <div class=" w-1/6 text-center">DETAILS</div>
            <div class=" w-1/6 text-center">EDIT</div>
            <div class=" w-1/6 text-center">DELETE</div>
        </div>
        @if($products->count()==0)
        ...
        <div class="flex flex-row   text-xl">
            ...
            <div class=" w-1/6 text-blue-500 border p-3"><a href="{{route('products.details', ['id'=>$product['id']])}}">details</a></div>
            <div class=" w-1/6 text-green-400 border p-3"><a href="{{route('products.edit', ['id'=>$product['id']])}}">edit</a></div>
